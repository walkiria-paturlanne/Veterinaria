 ...
 * @author Walkiria
 */
public class PantallaConejo extends javax.swing.JFrame {

    /**
     * Creates new form PantallaConejo
     */
    public PantallaConejo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Planilla de ingreso de conejos");
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8-conejo-64.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtTipoPelaje, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtColorPelaje, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtRaza, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(6, 6, 6)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(26, 26, 26)
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        rabbit.setHumano(txtDueño.getText());
        rabbit.setTelefono(txtTelefono.getText());
        rabbit.setDireccion(txtDomicilio.getText());
        rabbit.setCiudad(txtCiudad.getText());
        rabbit.setNombrePaciente(txtNombrePaciente.getText());
        rabbit.setFechanacimiento(Integer.parseInt(txtFechaNaci.getText()));
        rabbit.setRaza(txtRaza.getText());
        rabbit.setColorCabello(txtColorPelaje.getText());
        rabbit.setPelaje(txtTipoPelaje.getText());
        rabbit.setSexo(txtSexo.getText());
        rabbit.setPeso(Float.parseFloat(txtPeso.getText()));
        rabbit.setEspecie(txtEspecie.getText());

        lblEdad.setText(String.valueOf(rabbit.calcularEdad()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaConejo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaConejo().setVisible(true);
            }
        });
    }
