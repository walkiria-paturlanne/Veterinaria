...
public class PantallaGato extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Planilla de ingreso de felinos");
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8-gato-64.png"))); // NOI18N
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        cat.setHumano(txtDueño.getText());
        cat.setTelefono(txtTelefono.getText());
        cat.setDireccion(txtDomicilio.getText());
        cat.setCiudad(txtCiudad.getText());
        cat.setNombrePaciente(txtNombrePaciente.getText());
        cat.setFechanacimiento(Integer.parseInt(txtFechaNaci.getText()));
        cat.setRaza(txtRaza.getText());
        cat.setColorCabello(txtColorPelaje.getText());
        cat.setPelaje(txtTipoPelaje.getText());
        cat.setSexo(txtSexo.getText());
        cat.setPeso(Float.parseFloat(txtPeso.getText()));
        cat.setEspecie(txtEspecie.getText());
        
        lblEdad.setText(String.valueOf(cat.calcularEdad()));
